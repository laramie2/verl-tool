...
# ============================================================================
# MT-GRPO: Multi-Turn GRPO with Turn-Level Credit Assignment
# Reference: Multi-Turn-RL-Agent (arXiv:2505.11821)
# ============================================================================


def _mt_grpo_normalize(
    ...
    Args:
        ...
        index: UID/index for grouping (same prompt -> same index)
...
def _compute_turn_reward_from_tool_info(tool_interact_info: list[dict]) -> float:
    """
...
def _get_segment_boundaries(mask_row: torch.Tensor) -> list[int]:
    """
...
@register_adv_est(AdvantageEstimator.MT_GRPO)  # or simply: @register_adv_est("mt_grpo")
def compute_mt_grpo_outcome_advantage(
    ...
    config: Optional[AlgoConfig] = None,
    turn_reward: Optional[np.ndarray] = None,
