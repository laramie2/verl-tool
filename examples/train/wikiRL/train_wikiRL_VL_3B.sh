...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "'text_browser'" --workers_per_tool 4 --use_ray True & 
# python -m verl_tool.servers.serve --host $host --port $port --tool_type "'text_browser'" --workers_per_tool 4 --use_ray True > ${LOG_DIR}/text_browser_server.log 2>&1 &
server_pid=$!
